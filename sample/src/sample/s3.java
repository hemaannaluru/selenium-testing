package sample;//counting no.of links in a page
...
public class s3 {
	...
	public static void main(String[] args) {
		...
		List<WebElement>b=a.findElements(By.tagName("a"));// capturing whole tab stores the no.of elements into b //individual elements starts with a
